...
export const Configpj: IGbpStandardPageConfig<LegalPerson> = {
  ...
  fields: {
    ...
    inscricao_municipal: { label: "Inscrição Municipal", fieldType: "text" },
    ...
    atividade_principal: { label: "Atividade Principal", fieldType: "text" },
    atividades_secundarias: { label: "Atividades Secundárias", fieldType: "text" },
    ...
    autoriza_newsletter: { label: "Autoriza Newsletter", fieldType: "text" },
    ...
    comercial_complemento: { label: "Complemento Comercial", fieldType: "text" },
    comercial_microrregional: { label: "Microrregião Comercial", fieldType: "text" },
    ...
    residencial_complemento: { label: "Complemento Residencial", fieldType: "text" },
    residencial_microrregional: { label: "Microrregião Residencial", fieldType: "text" },
