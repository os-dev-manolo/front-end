...
import { UsoSolo } from "../../../../components/page-releated/consulta-previa/uso-solo/index";
import { Conclusion } from "../../../../components/page-releated/consulta-previa/conclusion";
import { CnaesPermitidos } from "../../../../components/page-releated/consulta-previa/laws/jacarezinho";
import { ICnae } from "../../../../shared/interfaces/IBCI";

export const JacarezinhoConsultaPrevia: React.FC = () => {
    ...
    const fetchConsultaPrevia = useCallback(async () => {
        document.title = `CONSULTA PRÉVIA - JCZ - ${subscription}`;
        try {
            setLoading(true);
