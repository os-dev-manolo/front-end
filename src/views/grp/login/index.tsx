...
import { ClientLogo, SemvLogo } from "../../../shared/assets/logos";
            ...
            <div className="flex flex-col w-full h-full justify-center">
                ...
                <div className="w-1/2 self-center">
                    <Form className="mt-10" onSubmit={handleSubmit}>
                        ...
                        />
                        <button
                            className="transition duration-300 ease-in-out w-100 p-2 bg-teal-0 text-teal-700 hover:text-white hover:bg-teal-700 rounded"
                            type="submit"
                            disabled={loading}
                        >
                            ENTRAR
